...
public class OrganizationServiceController {
     ...
     */
    @Operation(description = "Get organization by ID", security = @SecurityRequirement(name = "OAuth2-Token"))
    @GetMapping("/{id}")
     ...
     */
    @Operation(description = "Save organization", security = @SecurityRequirement(name = "OAuth2-Token"))
    @PostMapping
     ...
     */
    @Operation(description = "Update organization by ID", security = @SecurityRequirement(name = "OAuth2-Token"))
    @PutMapping("/{id}")
     ...
     */
    @Operation(description = "Delete organization by ID", security = @SecurityRequirement(name = "OAuth2-Token"))
    @DeleteMapping("/{id}")
