...
- [zuul-server](zuul-server): Gateway service to route requests using Netflix [Zuul](https://github.com/Netflix/zuul), running at 5555 port.
- [gateway-server](gateway-server): Gateway service to route requests using [spring-cloud-gateway](https://github.com/spring-cloud/spring-cloud-gateway/), running at 5555 port.
