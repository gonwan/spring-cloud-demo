...
public class LicenseServiceController {
     ...
     */
    @Operation(description = "Get licenses by organization ID")
     ...
     */
    @Operation(description = "Get license by organization ID and license ID")
    @Parameter(name = "Authorization", in = ParameterIn.HEADER, required = true, schema = @Schema(implementation = String.class, example = "Bearer <access_token>"))
     ...
     */
    @Operation(description = "Save license")
    @Parameter(name = "Authorization", in = ParameterIn.HEADER, required = true, schema = @Schema(implementation = String.class, example = "Bearer <access_token>"))
    @PostMapping
     ...
     */
    @Operation(description = "Update license")
    @Parameter(name = "Authorization", in = ParameterIn.HEADER, required = true, schema = @Schema(implementation = String.class, example = "Bearer <access_token>"))
     ...
     */
    @Operation(description = "Delete license")
    @Parameter(name = "Authorization", in = ParameterIn.HEADER, required = true, schema = @Schema(implementation = String.class, example = "Bearer <access_token>"))
